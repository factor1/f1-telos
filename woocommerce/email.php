...
<?php
	...
	echo sprintf( esc_html__( 'To redeem your 1 year membership, use coupon code %s during checkout or click on the following coupon:', 'woocommerce-smart-coupons' ), '<strong><code>' . esc_html( $coupon_code ) . '</code></strong>' );
?>
</p>
