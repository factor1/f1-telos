...
$bg = wp_get_attachment_image_src(get_field('extra_hero_background_image'), 'hero');
$topText = get_field('extra_hero_top_text');
$content = get_field('extra_hero_content');
?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        ...
        if( have_rows('extra_hero_buttons') ): ?>
          <div class="buttons">
            <?php while( have_rows('extra_hero_buttons') ): the_row(); 
